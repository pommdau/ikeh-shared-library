...
// 全てのUIパーツはNSViewを継承しているので、NSViewのExtensionとしてConstrainsのためのメソッドを用意する
extension NSView {
    ...
    func center(inView view: NSView, yConstant: CGFloat = 0) {
        translatesAutoresizingMaskIntoConstraints = false
        centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: yConstant).isActive = true
    }

    func centerX(inView view: NSView, topAnchor: NSLayoutYAxisAnchor? = nil, paddingTop: CGFloat = 0) {
        translatesAutoresizingMaskIntoConstraints = false
        centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
    ...
    func addConstraintsToFillView(_ view: NSView) {
        translatesAutoresizingMaskIntoConstraints = false
